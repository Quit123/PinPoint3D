...
def get_args_parser():
    ...
    parser.add_argument('--train_list', default='data/train_list.json', type=str)
    parser.add_argument('--val_list', default='data/val_list.json', type=str)
    

    # model
    parser.add_argument('--model_type', default='pinpoint3D', type=str, choices=['pinpoint3D'], 
                       help='Model type: pinpoint3D')
